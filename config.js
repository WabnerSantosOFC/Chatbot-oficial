window.CONFIG = {
  ...
  // ─── FALAS ATUALIZADAS PARA VENDA VIA PIX ─────
  responses: [
    {
      ...
      seq: [
        ...
        `Garanta agora antes que expire 👇<br><a href="{linkAcesso}" target="_blank" rel="noopener noreferrer" class="btn-acesso" onclick="notificarCliqueCompra('{nomeLead}')">💚 Pagar R$47 com Pix</a>`
      ]
    },
    {
      ...
      seq: [
        ...
        `Justo? 😊`,
        `<a href="{linkAcesso}" target="_blank" rel="noopener noreferrer" class="btn-acesso" onclick="notificarCliqueCompra('{nomeLead}')">🛡️ Quero Garantia + Meus Arquivos</a>`
      ]
    },
    {
      ...
      seq: [
        ...
        `<a href="{linkAcesso}" target="_blank" rel="noopener noreferrer" class="btn-acesso" onclick="notificarCliqueCompra('{nomeLead}')">💰 Garantir por R$47</a>`
      ]
    },
    {
      ...
      seq: [
        ...
        `<a href="{linkAcesso}" target="_blank" rel="noopener noreferrer" class="btn-acesso" onclick="notificarCliqueCompra('{nomeLead}')">✅ Quero Garantia + Meu ChatBot</a>`
      ]
    }
  ]
};